...
export const endpointsApi = {
  ...
  update: (uid: string, data: Partial<EndpointCreate>) => api.put<Endpoint>(`/ep/${uid}`, data),
...
export const datasetsApi = {
  ...
  update: (uid: string, data: Partial<DatasetCreate>) => api.put<Dataset>(`/datasets/${uid}`, data),
...
export const servicesApi = {
  ...
  update: (uid: string, data: Partial<ServiceCreate>) => api.put<Service>(`/services/${uid}`, data),
...
export const datasetEndpointsApi = {
  ...
  create: (data: DatasetEndpoint) => api.post<DatasetEndpoint>('/dataset-endpoints', data),
...
export const datasetServicesApi = {
  ...
  create: (data: DatasetService) => api.post<DatasetService>('/dataset-services', data),
...
export const serviceEndpointsApi = {
  ...
  create: (data: ServiceEndpoint) => api.post<ServiceEndpoint>('/service-endpoints', data),
